...
var handleRow = function(event, entry) {
  ...
  .then(response => {
    ...
    loginData.append("appid", "YU1mwM6SUbEapBlytGSc9HH7rfTCMoGlQ98uc3hAhcI3");
        ...
        method: "GET",
        url:
          "http://10.6.80.2:9081/api/v1.0/producer_ws/flask/projector/documents/" + this.$props.id + "?fieldList='offset,VPF_path,VPF_ind_path,images_path,overlay_path,removal_mark,mailpiece_id,oaccd,SuprvLgnid'&pageSize=20&key=" + this.$props.id,
        withCredentials: true,
        data: loginData
      })
        .then(response => {
